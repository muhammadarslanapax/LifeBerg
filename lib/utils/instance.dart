...
CompleteProfileController completeProfileController =
    CompleteProfileController.instance;


GoalController goalController = GoalController.instance;
PersonalDevelopmentController pDevController = PersonalDevelopmentController.instance;
